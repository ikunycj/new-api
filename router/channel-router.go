...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/failover/bindings", permission: authz.ChannelRead, handler: controller.GetChannelFailoverBindings},
	{method: http.MethodGet, path: "/failover/cluster-config", permission: authz.ChannelRead, handler: controller.GetClusterConfiguration},
