...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodPatch, path: "/failover/config/group-type", permission: authz.ChannelWrite, handler: controller.UpdateBillingGroupType},
	{method: http.MethodPost, path: "/failover/routes", permission: authz.ChannelWrite, handler: controller.CreateBillingGroupRoute},
	{method: http.MethodPatch, path: "/failover/routes/:route_id", permission: authz.ChannelWrite, handler: controller.UpdateBillingGroupRoute},
	{method: http.MethodDelete, path: "/failover/routes/:route_id", permission: authz.ChannelWrite, handler: controller.DeleteBillingGroupRoute},
	{method: http.MethodPost, path: "/failover/routes/:route_id/channels", permission: authz.ChannelWrite, handler: controller.SaveBillingGroupRouteChannel},
	{method: http.MethodPatch, path: "/failover/routes/:route_id/channels/:channel_id", permission: authz.ChannelWrite, handler: controller.SaveBillingGroupRouteChannel},
	{method: http.MethodDelete, path: "/failover/routes/:route_id/channels/:channel_id", permission: authz.ChannelWrite, handler: controller.DeleteBillingGroupRouteChannel},
	{method: http.MethodGet, path: "/probe/events", permission: authz.ChannelRead, handler: controller.StreamChannelProbeEvents},
	...
	{method: http.MethodDelete, path: "/:id/reconciliation/costs/:cost_id", permission: authz.ChannelWrite, handler: controller.DeleteChannelCostEntry},
