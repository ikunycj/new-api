...
func TestChannelProbeEventsRouteUsesReadPermission(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodGet, "/probe/events", authz.ChannelRead, controller.StreamChannelProbeEvents)
}
