...
const newKeys = {
  en: {
    ...
    'Add all matching channels': 'Add all matching channels',
  ...
  zh: {
    ...
    'Add channel': '添加渠道',
    'Add all matching channels': '添加全部匹配渠道',
    ...
    Loading: '加载中',
    Load: '负载',
    'Dynamic strategy weights must total 100%': '动态策略权重合计必须为 100%',
    Models: '模型',
  ...
  fr: {
    ...
    'Add all matching channels': 'Ajouter tous les canaux correspondants',
    ...
    Load: 'Charge',
    'Dynamic strategy weights must total 100%':
      'Le total des poids de stratégie dynamique doit être de 100 %',
    Models: 'Modèles',
  ...
  ja: {
    ...
    'Add channel': 'チャネルを追加',
    'Add all matching channels': '一致するチャネルをすべて追加',
  ...
  ru: {
    ...
    'Add all matching channels': 'Добавить все подходящие каналы',
    ...
    Load: 'Нагрузка',
    'Dynamic strategy weights must total 100%':
      'Сумма весов динамической стратегии должна составлять 100 %',
    Models: 'Модели',
  ...
  vi: {
    ...
    'Add all matching channels': 'Thêm tất cả kênh phù hợp',
    ...
    Load: 'Tải',
    'Dynamic strategy weights must total 100%':
      'Tổng trọng số chiến lược động phải bằng 100%',
    Models: 'Mô hình',
  ...
  'zh-TW': {
    ...
    'Add channel': '新增渠道',
    'Add all matching channels': '新增全部匹配渠道',
