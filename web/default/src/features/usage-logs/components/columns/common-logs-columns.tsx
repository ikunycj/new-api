    ...
    columns.push(
      ...
      },
      {
        ...
        cell: function RemarkCell({ row }) {
          ...
          if (!remark) return <span className='text-muted-foreground/40'>-</span>
          return (
            <TooltipProvider delay={300}>
              <Tooltip>
                <TooltipTrigger
                  render={<span className='block max-w-[140px] truncate text-xs' />}
                >
      ...
      },
      {
        ...
        cell: function EmailCell({ row }) {
          ...
          if (!email) return <span className='text-muted-foreground/40'>-</span>
          return (
            <TooltipProvider delay={300}>
              <Tooltip>
                <TooltipTrigger
                  render={<span className='block max-w-[180px] truncate text-xs' />}
                >
