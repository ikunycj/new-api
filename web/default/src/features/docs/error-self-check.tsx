...
const STREAM_DISCONNECTED_SECTION_TITLE = `2.3.1 ${STREAM_DISCONNECTED_ERROR}`

const ERROR_SELF_CHECK_TOC: DocsTocItem[] = [
  { id: 'error-directory', label: '1. 常见错误目录', level: 1 },
  { id: 'common-errors', label: '2. 常见错误', level: 1 },
  { id: 'openai-errors', label: '2.1 OpenAI官方错误', level: 2 },
  { id: 'user-errors', label: '2.2 用户自身错误', level: 2 },
  { id: 'relay-errors', label: '2.3 中转站错误', level: 2 },
  { id: 'other-errors', label: '2.4 其他错误', level: 2 },
]
          ...
          >
            ...
            >
              <h4 className='text-base leading-6 font-semibold tracking-tight break-words'>
                {STREAM_DISCONNECTED_SECTION_TITLE}
              </h4>
