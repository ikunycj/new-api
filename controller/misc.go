...
func SendEmailVerification(c *gin.Context) {
	...
	subject := strings.NewReplacer(
		"{{system_name}}", common.SystemName,
	).Replace(common.EffectiveSMTPVerificationSubject())
	content := strings.NewReplacer(
		"{{system_name}}", common.SystemName,
		"{{code}}", code,
		"{{valid_minutes}}", strconv.Itoa(common.VerificationValidMinutes),
	).Replace(common.EffectiveSMTPVerificationContent())
...
func SendPasswordResetEmail(c *gin.Context) {
	...
	if _, err := model.GetUniqueUserByEmail(email); err == nil {
		...
		subject := strings.NewReplacer("{{system_name}}", common.SystemName).Replace(common.EffectiveSMTPPasswordResetSubject())
		content := strings.NewReplacer(
			"{{system_name}}", common.SystemName,
			"{{reset_link}}", link,
			"{{valid_minutes}}", strconv.Itoa(common.VerificationValidMinutes),
		).Replace(common.EffectiveSMTPPasswordResetContent())
		err := common.SendEmail(subject, email, content)
		if err != nil {
